...
const systemBus = dbus_1.default.getBus('system');
systemBus.getInterface('org.bluez', '/org/bluez/hci0/dev_98_01_A7_AE_52_5C', 'org.freedesktop.DBus.Introspectable', (err, iface) => {
    if (err) {
        console.error(err);
        process.exit(1);
    }
